...
The value of t-computed (3.1697) is less than the tabulated t-value for 18 degrees of freedom (`r qt(0.975, 18)`). This confirms that we **can reject**, with a 95% confidence interval, the null hypothesis H0 of equality of the means, i.e., OJ is more effective than VC when the dosage is 0.5mg.
